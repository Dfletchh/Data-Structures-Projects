...
/*Rotate this node (*) left
  ...
  X   *  ===>   P   Z
    ...
    75        88
      \      /
       88  75
  Will fail if parent is null or not the right child
//*/
